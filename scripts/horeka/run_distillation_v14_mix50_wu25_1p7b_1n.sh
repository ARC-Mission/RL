#!/bin/bash
# 1.7B v14-mix50-wu25 self-distillation on 1 Horeka node (4× A100 80GB).
# Run from srun --pty bash inside a 1-node salloc.
#
# Topology: TP=1, CP=1, vLLM TP=1 → DP=4 on 4 GPUs.
# 1.7B fits comfortably at TP=1 even with the 33k teacher sequence.
...
NAME="d-1.7b-v14-mix50-wu25-1n-horeka"
